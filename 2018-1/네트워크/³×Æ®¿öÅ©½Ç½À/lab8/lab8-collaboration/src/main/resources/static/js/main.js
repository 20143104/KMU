...
$(document).ready(function (){
	...
	$(canvas).mousedown(function (event){
		isDown = true;
		oldPoint = {
				x: event.pageX - $(this).position().left - offsetX,
				y: event.pageY - $(this).position().top - offsetY
		};
	});
	$(canvas).mousemove(function (event){
		...
		stompClient.send("/app/chat.drawMessage", {}, JSON.stringify(drawMessage));
		oldPoint = newPoint;
	});
